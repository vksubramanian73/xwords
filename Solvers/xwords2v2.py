...
# faster!
# changes made: 
# only putting in VALID letters during brute force (checking this condition in a separate method)
# using a different lookup table (letter + pos to word instead of length to word)
# checking what words would be good based on the words i alr have
...
def placeLetters(puzzle, wordsUsed):
    ...
    letters, letterToWord = findLetters(lstPuzzle, wordsUsed, space)
